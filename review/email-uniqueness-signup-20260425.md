...
**<sub><sub>![P1 Badge](https://img.shields.io/badge/P1-orange?style=flat)</sub></sub>
Login never validates credentials — returns 200 for unregistered emails with any password**
...
Auth business logic is implemented directly in the HTTP handler — Clean Architecture violation**
...
Until this is extracted, the `userStore` Map is hidden inside the Hono factory function, making it impossible to test the uniqueness rule independently of HTTP.
...
**<sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub>
Signup token is generated but never stored — unredeemable by any future middleware**
